...
class UnbalancedDisk(gym.Env):
    ...
    def __init__(self, umax=3., dt = 0.025, render_mode='human'):
        ...
        self.TOP_GATE_SIGMA = 0.20  # rad (~26 deg): breedte van de "bij de top" zone (breder -> eerder zacht)
        self.W_U_TOP = 0.15         # straf op u^2 bij de top EN bijna stilstaand (hoger -> zachter vasthouden)
